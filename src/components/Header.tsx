...
export const Header = () => {
  return (
    <header className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-md border-b border-white/10 animate-[slideInDown_1s_ease-out]">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <img 
              ...
              className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg transition-all duration-300 group-hover:rotate-12 group-hover:shadow-lg group-hover:shadow-purple-500/25" 
            />
