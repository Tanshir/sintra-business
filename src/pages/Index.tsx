            ...
            <div className="relative">
              ...
              >
                <img 
                  ...
                  className="relative z-10 w-full max-w-4xl mx-auto h-auto rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-300 cursor-pointer animate-breathe" 
                />
              </a>
            </div>
          </div>
